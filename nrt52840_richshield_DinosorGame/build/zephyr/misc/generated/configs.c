...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_HOLTEK_HT16K33_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_HOLTEK_HT16K33_KEYSCAN_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_QDEC0, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HT16K33, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HT16K33_KEYSCAN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HT16K33_KEYSCAN_IRQ_THREAD_STACK_SIZE, 400);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HT16K33_KEYSCAN_IRQ_THREAD_PRIO, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HT16K33_KEYSCAN_DEBOUNCE_MSEC, 50);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HT16K33_KEYSCAN_POLL_MSEC, 200);
